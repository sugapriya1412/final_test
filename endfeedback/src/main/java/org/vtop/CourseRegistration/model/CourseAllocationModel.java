...
public class CourseAllocationModel {
	...
	public String toString() {
		return "CourseAllocationModel [classId=" + classId + ", semesterSubId=" + semesterSubId + ", courseId="
				...
				+ clsGrpMasterGroupId + ", classGroupModel=" + classGroupModel + ", totalSeats=" + totalSeats
				+ ", classType=" + classType + ", registeredSeats=" + registeredSeats + ", waitingSeats=" + waitingSeats
				+ ", specializationBatch=" + specializationBatch + ", arrearRegisteredSeats=" + arrearRegisteredSeats
				+ ", dummyNumberStatus=" + dummyNumberStatus + ", assoClassId=" + assoClassId + ", lockStatus="
				+ lockStatus + ", logUserId=" + logUserId + ", logTimeStamp=" + logTimeStamp + ", logIpAddress="
				+ logIpAddress + "]";
	}
