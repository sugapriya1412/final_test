...
public class CourseCatalogModel implements Serializable {
	...
	public String toString() {
		return "CourseCatalogModel [courseId=" + courseId + ", code=" + code + ", courseVersion=" + courseVersion
				+ ", title=" + title + ", genericCourseType=" + genericCourseType + ", lectureHours=" + lectureHours
				+ ", tutorialHours=" + tutorialHours + ", practicalHours=" + practicalHours + ", projectHours="
				+ projectHours + ", lectureCredits=" + lectureCredits + ", practicalCredits=" + practicalCredits
				+ ", projectCredits=" + projectCredits + ", credits=" + credits + ", prerequisite=" + prerequisite
				+ ", antirequisite=" + antirequisite + ", corequisite=" + corequisite + ", courseSystem=" + courseSystem
				+ ", evaluationType=" + evaluationType + ", councilNumber=" + councilNumber + ", pageNumber="
				+ pageNumber + ", discipline=" + discipline + ", groupCode=" + groupCode + ", ownerCode=" + ownerCode
				+ ", campusCode=" + campusCode + ", campusModel=" + campusModel + ", status=" + status + ", logUserId="
	...
	public String toString() {
		return "CourseCatalogModel [courseId=" + courseId + ", code=" + code + ", courseVersion=" + courseVersion
				...
				+ ", antirequisite=" + antirequisite + ", corequisite=" + corequisite + ", courseSystem=" + courseSystem
				+ ", evaluationType=" + evaluationType + ", councilNumber=" + councilNumber + ", pageNumber="
				+ pageNumber + ", discipline=" + discipline + ", groupId=" + groupId + ", programmeGroupModel="
				+ programmeGroupModel + ", groupCode=" + groupCode + ", ownerCode=" + ownerCode + ", campusCode="
				+ campusCode + ", campusModel=" + campusModel + ", status=" + status + ", logUserId=" + logUserId
