...
public class AppFilter implements Filter  
{
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException 
    {
        ...
        {	
        	...
        	if((uri.endsWith("endfeedback/")) && pass.equals(1))
        	{        		
	...
	{
		  return (uri.contains("ServerLimit") || uri.contains("/MandatoryScreenError") || uri.contains("leave/sms/reply") 
				  	|| uri.contains("gate/in/out") || uri.contains("gate/image") || uri.contains("SessionTimedOut") 
				  	|| uri.contains("processLogout") || uri.contains("AlreadyLogin") || uri.contains("MenuPrevillegeError") 
				  	|| uri.contains("assets")); 		
	}
	
	private boolean isFirstCall(String uri) 
	{
		return (uri.equals("/") || uri.contains("endfeedback") || uri.contains("processStudentLogin"));
	}
